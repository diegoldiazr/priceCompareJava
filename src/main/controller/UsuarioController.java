 ...
 * 
 * 
 * Esta entidad gestiona los diversos usuarios de articulos.
 * 
 * @author ddiaz
 *
 */
...
public class UsuarioController {
	...
	public ReturnAdapter getUsuarioById(
		...
		try{
			Usuario l = usuarioService.getUsuarioById(id);			
			if (l!=null){											
	...
	public ReturnAdapter getUsuarios(){
		ReturnAdapter result = new ReturnAdapter();
		try{
			List l = usuarioService.getUsuarios();
			if (l!=null){				
	...
	public ReturnAdapter save(@RequestBody Usuario usuario){
		ReturnAdapter result = new ReturnAdapter();
		try{
			result = usuarioService.saveUsuario(usuario);								
		}catch(Exception e){
			result = StandardResponse.getResponseInExceptionInt(e, log);
		}
		return result;
	...
	public ReturnAdapter update(
		...
		ReturnAdapter result = new ReturnAdapter();
		try{
			result = usuarioService.updateUsuario(id, usuario);						
		}catch(Exception e){
			result = StandardResponse.getResponseInExceptionInt(e, log);
		}
		return result;
